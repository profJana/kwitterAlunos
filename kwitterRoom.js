...
function addRoom()
{
  //armazenando o valor da sala criada na variável

  // acessando o banco de dados firebase, entrando na pasta principal com / e criando uma pasta no banco de dados com o nome da sala
  
  //também armazenamos esse nome da sala no local storage
    
  // alterando a página web para outro html
}
